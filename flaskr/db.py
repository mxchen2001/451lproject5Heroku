...
connection is stored and reused instead of creating a new connection if get_db
...
when the application has been created and is handling a request, so current_app
can be used.
...
connection exists, it is closed. Further down you will tell your application
...
Import and call this function from the factory. Place the new code at the end of
the factory function before returning the app.
"""
